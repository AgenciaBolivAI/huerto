...
/**
 * Cómo se baja el concepto de la lección a decisiones concretas: qué harías tú,
 * con lo que tienes, en el sitio donde estás.
 *
 * Rizoma del Sur es el **caso trabajado**, no el destino: se usa porque es un
 * lugar real con superficie, clima y limitaciones conocidas, y eso hace que las
 * decisiones sean verificables en vez de genéricas. Pero el lector puede no
 * tener un vivero —puede no tener tierra— y el bloque debe servirle igual. El
 * conocimiento del curso es de la persona, no del proyecto.
 */
      ...
      <div className="flex items-center gap-3 border-b border-crema-50/15 px-5 py-3.5 sm:px-7">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-0.5 truncate text-xs text-crema-100/70">
            {titulo ?? 'Rizoma del Sur como caso trabajado · Zanja Honda, Santa Cruz'}
          </p>
        </div>
      </div>
