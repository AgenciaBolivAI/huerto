...
import {
  ...
  Formula,
  Tabla,
} from '@/components/aula/mdx/bloques';
import { Diagrama, Ilustracion } from '@/components/aula/mdx/imagen';
import { AvisoVideoPendiente, ReproductorVideo, VideoNoEncontrado } from '@/components/aula/mdx/video';
import { Termino } from '@/components/aula/mdx/termino';
