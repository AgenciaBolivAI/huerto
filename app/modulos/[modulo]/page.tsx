...
import { BarraProgreso, InsigniaEstado, PuntoEstado } from '@/components/curso/piezas';
import { listarIdsModulos, obtenerCurso, obtenerModuloCompleto } from '@/lib/contenido';
