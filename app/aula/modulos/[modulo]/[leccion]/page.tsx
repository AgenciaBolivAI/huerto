...
import { AvisoPrerrequisitos } from '@/components/aula/leccion/aviso-prerrequisitos';
import { BotonCompletar } from '@/components/aula/leccion/boton-completar';
import { IndiceLeccion } from '@/components/aula/leccion/indice-leccion';
import { RegistradorLeccion } from '@/components/aula/leccion/registrador';
import { PortadaLeccion } from '@/components/aula/mdx/imagen';
import { AvisoVideoPendiente } from '@/components/aula/mdx/video';
import { EditorNotas } from '@/components/aula/notas/editor-notas';
import { Quiz } from '@/components/aula/quiz/quiz';
import {
  buscarLeccionPorId,
  listarIdsModulos,
  ...
  obtenerQuiz,
  obtenerVecinas,
} from '@/lib/aula/contenido';
import { extraerSecciones, renderizarLeccion } from '@/lib/aula/mdx';
import {
  obtenerIntentos,
  obtenerNota,
    ...
    <>
      ...
      <div className="seccion py-10">
        <nav className="text-sm text-tinta-500 dark:text-crema-100/45">
          ...
          <Link
            href={`/aula/modulos/${params.modulo}`}
